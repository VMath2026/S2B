...
def _build_system_prompt(
    ...
    return (
        ...
        "- delivery_address: delivery address for courier delivery.\n"
        "- phone: real phone number for order confirmation, at least 10 digits.\n"
        ...
        "- Do not accept impossible dates like 200.200, 31.02, 99.99, or dates in the past.\n"
        "- If date is ambiguous, ask for a real date like завтра, пятница, 12.06, or 12 июня.\n"
        "- Do not accept a phone unless it has 10-15 digits.\n"
        ...
        "Required fields for is_ready_for_manager=true and state.is_ready_for_confirmation=true: recipient, occasion, budget, style, delivery_date, delivery_address, phone, selected_flowers, estimated_price. "
        "Phone must look like a real phone number with at least 10 digits. "
